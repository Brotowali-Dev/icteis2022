        ...
        <div className='dateFlow'>
          <div className='dateWidth'>
            <div className='dateIcon'>
              {/* className='dateIconDisable' */}
              <img src='/assets/file-upload.svg' alt='submissionIcon' />
            </div>
            <div className=' dateTitle'>Submission Deadline</div>
            {/* className='dateTitleDisable' */}
            <div className='dateDates'>{datas.submissionDeadline}</div>
            {/* className = 'dateDatesDisable */}
          </div>
